...
MANDATORY_SOURCE_FILES = (
    ...
    "bin_verify/v2_canary_executor.py", "bin_verify/v2_real_executor_child.py", "bin_verify/.v2_real_executor_runtime.py", "bin_verify/v2_grant_authority.py", "bin_verify/v2_executor_launcher.c", "bin_verify/mint_cmux_receipt.py",
