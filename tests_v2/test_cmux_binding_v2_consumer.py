...
NOW=dt.datetime.now(dt.timezone.utc); TASK='t_beefcafe'; SESSION='1194f145-bc7d-4fd6-9762-16b4414eb4d1'; WS='9A3E7E93-963F-45AB-9A00-79E218190B5D'; SF='577E1920-C0EE-4140-A649-361647B6B9A5'; MWS='44444444-AAAA-BBBB-CCCC-000000000004'; MSF='66666666-AAAA-BBBB-CCCC-000000000006'
...
def setup(r):
 ...
 res={'record_kind':'cmux-manual-seat-reservation','schema_version':2,'seat':{'cmux_workspace_id':WS,'cmux_surface_id':SF,'cmux_daemon_version':'0.64.20','provider':'claude-code','kind':'cmux-interactive-claude-max','provider_session_uuid':SESSION},'mint_control':{'cmux_workspace_id':MWS,'cmux_surface_id':MSF}}
 res['provider_anchor_fingerprint']=issuer.dual_anchor.anchor_fingerprint(res['seat']); res['mint_control_anchor_fingerprint']=issuer.dual_anchor.anchor_fingerprint(res['mint_control']); res['reservation_fingerprint']=issuer.reservation_fingerprint(res); rp=r/'r.json';put(rp,res)
 rec={'receipt_kind':'mac-cmux-reservation-receipt','schema_version':3,'minted_at_utc':iso(NOW-dt.timedelta(seconds=1)),'expires_at_utc':iso(NOW+dt.timedelta(seconds=300)),'canary_task':TASK,'reservation_fingerprint':res['reservation_fingerprint'],'provider_anchor_fingerprint':res['provider_anchor_fingerprint'],'mint_control_anchor_fingerprint':res['mint_control_anchor_fingerprint'],'cmux_workspace_id':WS,'cmux_surface_id':SF,'mint_control_context':{'surface_id':MSF,'workspace_id':MWS,'resolved_surface_id':MSF,'resolved_workspace_id':MWS,'tty':'/dev/ttys012','proof':'nonce-read-screen','nonce_sha256':hashlib.sha256(b'consumer-fixture-nonce').hexdigest()},'control_socket':{'cmux_daemon_version':'0.64.20','bundle_identifier':'com.cmuxterm.app'}};rec['receipt_fingerprint']=issuer.receipt_fingerprint(rec); cp=r/'c.json';put(cp,rec)
